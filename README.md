...
| **热点与爆款拆解** | 聚合公开热点源；爆款拆解支持最多 80 张带序号截图、可点击宫格大图、全量镜头语言分析，以及无台词视频的猜剧本与生成准备。 |
...
- **爆款拆解**：截图间隔会按视频时长自动限制为最多 80 张，并实时显示预计张数；每张截图右下角带序号，宫格具有清晰分隔线且可点击查看大图，重新生成后通过版本参数立即刷新。
